...
//Prototipo de funciones para despachar al cliente
void despacharOso();
void despacharEBC();
void despacharMcBurger();
void despacharC();
...
void agregarpapas()
{
    ...
    cout<<"Agregado con exito :D, presione enter para continuar"<<endl;
...
void AgregarCrepa()
{
    ...
    cout<<"Agregado con exito!, presione enter para continuar"<<endl;
...
//Funciones para despachar al cliente
void despacharC()
{
    despacharOso();
    despacharEBC();
    ...
    float precioFinal=0;
    precioFinal = precioFinal+sumaOso+sumaMB+sumaEBC;

    cout << endl << "---------------------------------------------------------------------"<<endl;
    cout << endl << "EL TOTAL A CANCELAR ES: $" << precioFinal << endl << endl;
}

//Funcion despachar para Oso Meloso
void despacharOso() 
{
    cout << endl << "---------------------------------------------------------------------"<<endl;
    cout << endl << "---Restaurante: OSO MELOSO---" << endl;
...
//Funcion despachar para McBurger
void despacharMcBurger()
{
    cout<<"---------------------------------------------------------------------"<<endl;
    cout << endl << "---Restaurante: McBURGER---" << endl;
